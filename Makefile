...
SOURCES       = texteditor.cpp \
		...
		animationwidget.cpp \
		uiwidgets.cpp \
		overlays.cpp moc_texteditor.cpp \
...
compiler_moc_header_make_all: moc_texteditor.cpp moc_linenumberarea.cpp moc_hexeditor.cpp moc_aiautocomplete.cpp moc_aisettingsdialog.cpp moc_disassembler.cpp moc_binaryinspector.cpp moc_markdownviewer.cpp moc_audiomonitor.cpp moc_codegraph.cpp moc_syntaxhighlighter.cpp moc_keyheatmap.cpp moc_vimmode.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_texteditor.cpp moc_linenumberarea.cpp moc_hexeditor.cpp moc_aiautocomplete.cpp moc_aisettingsdialog.cpp moc_disassembler.cpp moc_binaryinspector.cpp moc_markdownviewer.cpp moc_audiomonitor.cpp moc_codegraph.cpp moc_syntaxhighlighter.cpp moc_keyheatmap.cpp moc_vimmode.cpp
